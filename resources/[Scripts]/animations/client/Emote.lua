...
AddEventHandler('animations:client:SmokeWeed', function()
  ...
  Citizen.CreateThread(function()
    while SmokingWeed do
      Citizen.Wait(10000)
      TriggerServerEvent('helix-hud:Server:RelieveStress', math.random(15, 18))
...
function EmoteChatMessage(args)
  if args == display then
    TriggerEvent("chatMessage", "Ajuda", false, string.format(""))
  else
    TriggerEvent("chatMessage", "Ajuda", false, string.format(""..args..""))
  end
end
